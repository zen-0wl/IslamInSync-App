...
class SurahAlWaaqiaPage extends StatefulWidget {
  @override
  _SurahAlWaaqiaPageState createState() => _SurahAlWaaqiaPageState();
}

class _SurahAlWaaqiaPageState extends State<SurahAlWaaqiaPage> {
  final String apiUrl = 'http://api.alquran.cloud/v1/surah/56';
          ...
          if (snapshot.connectionState == ConnectionState.waiting) {
            ...
            return ListView(
              children: [
                ...
                ListTile(
                  title: Text('Number of Ayahs: ${surahData['numberOfAyahs']}'),
                ),
